...
## Project Structure
    ...
    ├── new_cultural_vision_35887  # Django project configurations
...
1. Clone this repo and `cd new_cultural_vision_35887`
...
2. Clone this repo and `cd new_cultural_vision_35887`
